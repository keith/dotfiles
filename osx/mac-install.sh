...
formulas=(bash cloc ctags git grc grep heroku-toolbelt hub imagemagick less llvm macvim mercurial mogenerator "mutt --with-sidebar-patch" node openssh openssl python readline reattach-to-user-namespace sqlite the_silver_searcher tmux tree vim wget zsh zsh-completions)
