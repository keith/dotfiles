...
FILES=(bashrc bin gemrc gitignore_global gvimrc hgrc inputrc irbrc irssi mutt muttrc rspec slate.js tm_properties tmux.conf tmux-powerlinerc vim vimrc xvimrc zshrc)
NO_DOT=()
