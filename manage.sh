...
FILES=(backupignore bashrc bin gemrc gitconfig gitignore_global gvimrc hgrc inputrc irbrc irssi mutt muttrc notmuch-config npmrc offlineimaprc rspec psqlrc pylintrc shellrc slate.js tm_properties tmux.conf tmux-powerlinerc vim vimrc Xdefaults Xmodmap xvimrc zshrc)
NO_DOT=()
