...
FILES=(bashrc bin gemrc gitignore_global gvimrc hgrc irbrc irssi mutt muttrc rspec slate tm_properties tmux.conf tmux-powerlinerc vim vimrc xvimrc zshrc)
NO_DOT=()
