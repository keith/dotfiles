...
function! airline#themes#custom#refresh()
  ...
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Base colors
  let s:base00  = {'t': s:ansi_colors ?  11 : (s:tty ? '7' : 241), 'g': '#cccccc'}
  let s:base01  = {'t': s:ansi_colors ?  10 : (s:tty ? '0' : 240), 'g': '#999999'}
  let s:base02  = {'t': s:ansi_colors ? '0' : (s:tty ? '0' : 235), 'g': '#393939'}
  let s:base03  = {'t': s:ansi_colors ?   8 : (s:tty ? '0' : 234), 'g': '#2d2d2d'}
  let s:base0   = {'t': s:ansi_colors ?  12 : (s:tty ? '7' : 244), 'g': '#ebe4d3'}
  ...
  let s:blue    = {'t': s:ansi_colors ?   4 : (s:tty ? '4' : 33 ), 'g': '#99cccc'}
  let s:cyan    = {'t': s:ansi_colors ?   6 : (s:tty ? '6' : 37 ), 'g': '#d2fdfe'}
  let s:green   = {'t': s:ansi_colors ?   2 : (s:tty ? '2' : 64 ), 'g': '#99cc99'}
  let s:magenta = {'t': s:ansi_colors ?   5 : (s:tty ? '5' : 125), 'g': '#d567af'}
  let s:orange  = {'t': s:ansi_colors ?   9 : (s:tty ? '1' : 166), 'g': '#f99157'}
  let s:red     = {'t': s:ansi_colors ?   1 : (s:tty ? '1' : 160), 'g': '#f2777a'}
  let s:violet  = {'t': s:ansi_colors ?  13 : (s:tty ? '5' : 61 ), 'g': '#cc99cc'}
  let s:yellow  = {'t': s:ansi_colors ?   3 : (s:tty ? '3' : 136), 'g': '#fedb78'}
  ...
  if s:background == 'dark'
    let s:N1 = [s:base3,  s:base02, 'bold']
  ...
  let g:airline#themes#custom#palette.inactive = airline#themes#generate_color_map(
  ...
  let g:airline#themes#custom#palette.normal = airline#themes#generate_color_map(
  ...
  let g:airline#themes#custom#palette.insert = airline#themes#generate_color_map(
  ...
  let g:airline#themes#custom#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#custom#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#custom#palette.replace_modified = {
  ...
  let g:airline#themes#custom#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#custom#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction
